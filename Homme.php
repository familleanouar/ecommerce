...
<div class="row" id="vet">
    ...
    $ajout = $conn->query("select * from vetements where sexe='Homme' ORDER BY rand()");
    foreach($ajout as $r) {
    ...
    <div class='thumbnail' >
        ...
        <div class='caption' >
            <h4 class='pull-right' > ".$r['prix'] . ",00 MAD</h4 >
             <h4 ><a href ='description.php?table=vetements&Type=".$r['Type']."&ID=".$r['ID']."&sexe=Homme' > " .$r['Nom'] ."</a >
            </h4 >
            <p >".$r['description']."</p>
        </div >
          </div >
...
<script>
    ...
    function test() {
        ...
        instance.open("get","traitement.php?table=<?php echo $_GET['table'];?>&Type=<?php echo $_GET['Type'];?>&sexe=Homme",true);
        instance.send(null);
    }
